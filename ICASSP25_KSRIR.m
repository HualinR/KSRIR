...
%
% Inputs:
%   BF_RIR_CR : Reference B-format RIR [samples x channels x RIRs]
...
%
% Outputs:
%   LQ        : Listening Quality score based on KS test
%   LA        : Localization Accuracy score based on weighted KS stats
